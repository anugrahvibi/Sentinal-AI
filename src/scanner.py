...
def scan_model(model_path):
    # ← only change: get trigger from reverse_engineer instead of hardcoded value
    ...
    print(f"[scanner] Using trigger: '{trigger}'")
    ...
    output = {
        ...
        "trigger_word": trigger,        # now shows discovered trigger
        "summary": {
